...
export const paid_by_return = async (data: return_fra) => {
    try {
        ...
        const update_produit_sell = await prisma.produit_sell.update({
            ...
            data: {
                quantite: {
                    decrement:  quantite_attendue_retourner // this is mean quantite = quantite - quantite_attendue_retourner
                }
            }
        });
        ...
        const update_produit = await prisma.produit_Final.update({
            ...
            data: {
                quantite: {
                    increment: quantite_reel_retourner // this is mean quantite = quantite + quantite_reel_retourner
                }
            }
        });
